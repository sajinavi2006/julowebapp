    ...
    >
      {isUserActive ? (
        <div className={`${dFlex} ${flexColumn} ${justifyBetween} ${h100}`}>
          <div className={`${dFlex} ${justifyBetween} ${textWhite}`}>
            <div>
              ...
              <div className={`${fontNormal} ${opacity(0.85)} ${fontSize(14)}`}>
                Limit total{' '}
                {formatMoney(userData?.creditInfo?.set_limit)}
              </div>
            </div>
          ...
          <div className={`${dFlex} ${justifyBetween} ${textWhite} ${mt5}`}>
            <div>
              ...
              >
                {formatMoney(
                  userData?.creditInfo?.available_limit
                )}
              </div>
            </div>
            <div
            ...
            >
              ...
              <div className={`${fontNormal} ${fontSize(14)} ${textRight}`}>
                {utils.string.formatMoney(userData?.creditInfo?.used_limit)}
              </div>
            </div>
          </div>
        </div>
        ...
        <>
          ...
          {userData?.creditInfo?.limit_message && (
            <div
              className={`${textWhite} ${padding(
                '50px 0px 0px 0px'
